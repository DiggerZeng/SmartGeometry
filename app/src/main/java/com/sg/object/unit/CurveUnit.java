...
//	}
    ...
    // 返回曲线上两个 y 坐标相同的点，超出定义域则返回 null
    ...
    // 根据 y 点返回曲线上 x 坐标相同的最近点，超出定义域则返回 null
    ...
    // 返回曲线上两个 x 坐标相同的点，超出定义域则返回 null
...
//		}
    ...
    public void setOverHalf(boolean isOverHalf) {
        this.isOverHalf = isOverHalf;
    }
