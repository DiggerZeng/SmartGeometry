...
//	private Point endPoint;
	...
	*/
    ...
    //cai 切点
    private PointUnit tangentPoint;
...
/*		int n = pList.size();
    ...
    public void translate(float[][] transMatrix) {
        ...
        if(tangentPoint != null) {
            tangentPoint.translate(transMatrix);
        }
    }
    ...
    public void scale(float[][] scaleMatrix, Point translationCenter) {
        ...
        if(tangentPoint != null) {
            tangentPoint.scale(scaleMatrix, translationCenter);
        }
    }
    ...
    public void rotate(float[][] rotateMatrix, Point translationCenter) {
        ...
        if(tangentPoint != null) {
            tangentPoint.rotate(rotateMatrix, translationCenter);
        }
    }

    public PointUnit getTangentPoint() {
        return tangentPoint;
    }

    public void setTangentPoint(PointUnit tangentPoint) {
